 ...
 */
    ...
    class Form {
        ...
        public function render(){
            ...
            include './form2.php'; // HTML de düzenlediğim formu include ile render fonksiyonuna çekip gerekli parametreleri almasını sağlıyorum
        ...
        public static function createPostForm(string $action): Form 
        {
            ...
            $getPostForm = self::createForm($action, "POST");
        ...
        public static function createGetForm(string $action): Form 
        {
            ...
            $getGetForm = self::createForm($action, "GET");
